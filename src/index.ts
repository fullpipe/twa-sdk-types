export interface Telegram { WebApp: WebApp }
 ...
 */
onEvent<T extends keyof EventCallbacks>(eventType: T, eventHandler: EventCallbacks[T]): void

/**
 * A method that deletes a previously set event handler.
 */
offEvent<T extends keyof EventCallbacks>(eventType: T, eventHandler: EventCallbacks[T]): void
...
[EventType.invoiceClosed]: (e: {url: string, status: "paid"|"cancelled"|"failed"|"pending"}) => void;
...
[EventType.writeAccessRequested]: (e: {status: "allowed"|"cancelled"}) => void;
[EventType.contactRequested]: (e: {status: "sent"|"cancelled"}) => void;
[EventType.biometricManagerUpdated]: () => void;
[EventType.biometricAuthRequested]: (e: {isAuthenticated: boolean, biometricToken?: string}) => void;
[EventType.biometricTokenUpdated]: (e: {isUpdated: boolean}) => void;
[EventType.fullscreenChanged]: () => void;
[EventType.fullscreenFailed]: (e: {error: "UNSUPPORTED"|"ALREADY_FULLSCREEN"}) => void;
[EventType.homeScreenAdded]: () => void;
[EventType.homeScreenChecked]: (e: {status: "unsupported"|"unknown"|"added"|"missed"}) => void;
...
[EventType.shareMessageFailed]: (e: {error: "UNSUPPORTED"|"MESSAGE_EXPIRED"|"MESSAGE_SEND_FAILED"|"USER_DECLINED"|"UNKNOWN_ERROR"}) => void;
[EventType.emojiStatusSet]: () => void;
[EventType.emojiStatusFailed]: (e: {error: "UNSUPPORTED"|"SUGGESTED_EMOJI_INVALID"|"DURATION_INVALID"|"USER_DECLINED"|"SERVER_ERROR"|"UNKNOWN_ERROR"}) => void;
[EventType.emojiStatusAccessRequested]: (e: {status: "allowed"|"cancelled"}) => void;
[EventType.fileDownloadRequested]: (e: {status: "downloading"|"cancelled"}) => void;
}
/**
 ...
 */
setItem(key: string, value: string, callback?: (err: Error | null, success: boolean) => void): CloudStorage;
 ...
 */
getItem(key: string, callback: (err: Error | null, value: string) => void): CloudStorage;
 ...
 */
getItems(keys: string[], callback: (err: Error | null, values: string[]) => void): CloudStorage;
 ...
 */
removeItem(key: string, callback?: (err: Error | null, success: boolean) => void): CloudStorage;
 ...
 */
removeItems(keys: string[], callback?: (err: Error | null, success: boolean) => void): CloudStorage;
 ...
 */
setItem(key: string, value: string, callback?: (err: Error | null, success: boolean) => void): DeviceStorage;
 ...
 */
getItem(key: string, callback: (err: Error | null, value: string) => void): DeviceStorage;
 ...
 */
removeItem(key: string, callback?: (err: Error | null, success: boolean) => void): DeviceStorage;
 ...
 */
clear(callback?: (err: Error | null, success: boolean) => void): DeviceStorage;
}
/**
 ...
 */
setItem(key: string, value: string, callback?: (err: Error | null, success: boolean) => void): SecureStorage;
 ...
 */
getItem(key: string, callback: (err: Error | null, value: string) => void): SecureStorage;
 ...
 */
restoreItem(key: string, callback?: (err: Error | null, value?: string) => void): SecureStorage;
 ...
 */
removeItem(key: string, callback?: (err: Error | null, success: boolean) => void): SecureStorage;
 ...
 */
clear(callback?: (err: Error | null, success: boolean) => void): SecureStorage;
}
/**
